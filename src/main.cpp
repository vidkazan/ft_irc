...
//        if(it->getLastCode() > 0 && it->getLastCode() < 2000)
        ...
        std::cout << "|" << std::setw(10) << it->getNickName() << "|" << std::setw(4) << it->getSocketFd() << "|"<< std::setw(10) << it->getRequest().getRequestMethod() << "|" <<  std::setw(6) << code << "|" << std::setw(10) << it->getRequest().getBytesReceieved() << "|\n";
    }
    std::cout << " ---------------------------------------------\n";
    std::cout << " ---------------------------------------------\n";
